...
# Labels
ax_c.text(0.55*x, 0.55*y, r"$\vec r(t)$",
          fontsize=12, color="red")
ax_c.text(x/2, -0.15, r"$A\cos\theta$", ha="center")
ax_c.text(x+0.05, y/2, r"$A\sin\theta$", va="center")
